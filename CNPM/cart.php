...
<?php include "includes/header.php" ?>
				...
				<main class="col-md-9">
					<div class="card">
									...
									<td>
										<figure class="itemside">
											...
											<figcaption class="info">
												<a href="#" class="title text-dark">name</a>
						...
						<div class="card-body border-top">
							<a href="#" class="btn btn-primary float-md-right"> Đặt hàng<i
					...
					<div class="alert alert-success mt-3">
						<p class="icontext"><i class="icon text-success fa fa-truck"></i> Giao hàng miễn phí trong vòng 1-2 ngày
						</p>
					</div>
					...
					<div class="card">
						<div class="card-body">
							<dl class="dlist-align">
								<dt>Tổng:</dt>
								<dd class="text-right">USD 1568</dd>
							</dl>
							<dl class="dlist-align">
								<dt>Giảm giá:</dt>
							...
							<dl class="dlist-align">
								<dt>Tổng tiền:</dt>
								<dd class="text-right  h5"><strong>$1,000</strong></dd>
							</dl>
							<hr>
	...
	<section class="section-name bg padding-y">
		<div class="container">
			...
			<p>10 ngày , nếu sản phẩm lỗi sẽ hoàn tiền</p>
